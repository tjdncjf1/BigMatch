/**
 * Program : common.js Date : 2016-04-21 Description: 홈화면 swiper 속성 수정. Modify :
 * 서우철 History : - 2016-04-21 작성자 : 서우철 swiper를 먹이기 위해 속성 부여.
 * 
 */
var swiper;
 $(function(){
 ...
 function moveRankingPage() {
	swiper.slideTo(1);
	$('#record #tabs ul li a').last().click();
 }