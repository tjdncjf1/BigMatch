...
$(document).on("pagecreate",function() {
	...
	function scale(width, height, padding, border) {
		var scrWidth = $(window).width() - 30, scrHeight = $(
						window).height() - 30, ifrPadding = 2 * padding, ifrBorder = 2 * border, ifrWidth = width
						+ ifrPadding + ifrBorder, ifrHeight = height
	...
	$("#popupMap").on({
		popupbeforeposition : function() {
			var size = scale(600, 700,0, 0), w = size.width, h = size.height;
